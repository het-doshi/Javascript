...
const person1 = 
[  
   { name : "Alex", age : 20, email : "alex2021"}, { name : "alice", age : 20, email : "alex2021"}, 
]

const person2 = 
[  
   { name : "Raju", age : 20, email : "alex2021"}, { name : "alice", age : 21, email : "Alex2021"}, 
]


const allObjs =  [...person1, ...person2]

for(let i = 0; i < allObjs.length; i++)
{
    var combine = Object.assign({}, allObjs[i]);
}
